...
config['IMAGES'] = {
  'map': '${PATHS:images}map.jpg',
  'food': '${PATHS:resources}food.png',
  'metal': '${PATHS:resources}metal.png',
  'oil': '${PATHS:resources}oil.png',
  'wood': '${PATHS:resources}wood.png',
  'anti-air': '${PATHS:attributes}anti-air.png',
  'aquadef': '${PATHS:attributes}aquadef.png',
  'aquatic': '${PATHS:attributes}aquatic.png',
  'arial': '${PATHS:attributes}arial.png',
  'capacity': '${PATHS:attributes}capacity.png',
  'carrier': '${PATHS:attributes}carrier.png',
  'defense': '${PATHS:attributes}defense.png',
  'hover': '${PATHS:attributes}hover.png',
  'movement': '${PATHS:attributes}movement.png',
  'naval': '${PATHS:attributes}naval.png',
...
config['BACKGROUND'] = {
  ...
  'info': '''
    ...
    color:cornsilk,
    border:5,
    icontopleft:(1175.605),
    iconbottomright:(1215.645)
    '''
}
...
config['TERRITORIES'] = {
  'alaska': '''
    ...
    land:[(046.183)|(055.177)|(066.169)|(071.161)|(072.163)|(081.162)|(087.159)|(089.153)|(094.157)|(104.160)|
      ...
      (116.115)|(116.115)|(116.097)|(104.092)|(094.091)|(085.085)|(069.086)|(062.093)|(062.098)|(052.098)|(048.101)|
  ...
  'northwest_territory': '''
    ...
    land:[(118.098)|(118.114)|(115.117)|(114.143)|(118.147)|(165.147)|(168.149)|(244.149)|(251.151)|(264.138)|
      ...
      (283.100)|(277.101)|(271.084)|(283.070)|(281.067)|(268.069)|(256.081)|(256.100)|(254.100)|(246.092)|(243.092)|
  ...
  'greenland': '''
    ...
    land:[(381.174)|(366.161)|(363.147)|(360.140)|(359.133)|(362.127)|(363.123)|(360.121)|(357.118)|(359.115)|
      ...
      (381.041)|(390.032)|(395.030)|(401.027)|(404.029)|(409.032)|(416.032)|(423.032)|(437.035)|(440.039)|(433.041)|
      (431.044)|(440.044)|(450.041)|(453.039)|(459.038)|(465.040)|(465.044)|(459.048)|(453.058)|(453.065)|(454.067)|
      (454.074)|(454.078)|(457.082)|(455.085)|(452.091)|(446.092)|(446.098)|(451.102)|(452.106)|(446.107)|(439.107)|
  ...
  'ural': '''
    ...
    land:[(826.268)|(824.263)|(817.255)|(812.256)|(808.252)|(796.251)|(792.248)|(790.243)|(782.243)|(781.238)|
      ...
      (757.103)|(756.099)|(752.097)|(750.094)|(750.092)|(752.091)|(753.080)|(755.078)|(756.071)|(757.069)|(759.069)|
      (763.073)|(767.077)|(773.079)|(772.086)|(770.090)|(770.092)|(777.100)|(779.105)|(777.108)|(776.111)|(774.116)|
  ...
  'siberia': '''
    ...
    land:[(875.265)|(866.263)|(864.254)|(859.247)|(857.246)|(853.249)|(849.248)|(843.242)|(843.232)|(841.229)|
      ...
      (796.121)|(796.115)|(791.103)|(790.103)|(783.101)|(775.091)|(777.081)|(780.079)|(782.080)|(787.089)|(793.091)|
      (794.087)|(790.080)|(787.074)|(788.067)|(790.066)|(795.073)|(801.075)|(799.074)|(794.067)|(794.060)|(797.059)|
      (802.059)|(805.062)|(806.056)|(806.053)|(810.053)|(816.048)|(821.044)|(828.043)|(834.039)|(846.038)|(847.041)|
      (850.040)|(853.038)|(855.034)|(859.034)|(863.042)|(865.044)|(876.044)|(876.056)|(870.058)|(864.063)|(860.068)|
      (863.068)|(871.061)|(877.057)|(883.060)|(885.062)|(888.059)|(898.060)|(901.063)|(904.069)|(905.072)|(909.073)|
      (911.079)|(909.081)|(908.084)|(906.102)|(896.103)|(893.102)|(884.108)|(883.109)|(883.112)|(890.113)|(893.118)|
  ...
  'yakutsk': '''
    ...
    land:[(944.139)|(926.140)|(923.143)|(919.143)|(917.141)|(915.152)|(910.153)|(906.156)|(904.156)|(902.152)|
      ...
      (915.053)|(922.054)|(924.054)|(924.064)|(934.070)|(938.067)|(952.067)|(951.059)|(968.057)|(970.062)|(973.062)|
      (975.059)|(977.058)|(983.062)|(983.067)|(990.067)|(993.071)|(990.078)|(989.081)|(979.087)|(978.100)|(987.109)|
  ...
  'kamchatka': '''
    ...
    land:[(1012.215)|(1009.204)|(1005.197)|(1005.186)|(1002.185)|(1001.182)|(1000.179)|(993.177)|(986.179)|
      ...
      (1104.110)|(1102.106)|(1103.102)|(1101.098)|(1096.095)|(1092.092)|(1085.092)|(1083.088)|(1075.083)|(1065.079)|
      (1061.074)|(1059.071)|(1047.071)|(1040.071)|(1040.072)|(1038.076)|(1036.078)|(1033.075)|(1011.075)|(1007.069)|
      (999.066)|(996.070)|(993.073)|(992.078)|(986.084)|(980.088)|(980.095)|(980.101)|(985.107)|(989.110)|(984.121)|
